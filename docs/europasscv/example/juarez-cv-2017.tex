...
%   }
  ...
  \ecvtitlelevel{}{\textit{Urban Art. Expressive uses of public space}}{\href{http://ramoneando.com/docs/Juarez,Benjamin_M.pdf}{\texttt{*online pdf link}}   }   %\vspace*{-4mm}
...
\ecvblueitem{}{Córdoba, Argentina.}
  ...
  Sent to \textit{Apuntes de Investigación del CECYP}, Buenos Aires. 
 ...
 \pagebreak
  ...
  \ecvtitle{March 2016 – Present}{Research team} 
  ...
  \textit{Corporeal management practices and processes of subjectification in the contemporary culture} -- with Professor María Inés Landa}
  ...
  \ecvtitle{March 2011 – December 2011}{Research team} 
  \ecvitem{}{SECYT / Universidad Nacional de Córdoba -- UNC [Córdoba. Argentina]}
  \ecvitem{}{\textit{Contemporary subjectivities} -- with Professor Gustavo Blázquez}
  ...
  \ecvtitle{October 2004 – April 2007}{Undergraduate researcher} 
  \ecvitem{}{Instituto de Investigación Gino Germani -- IIGG  [Buenos Aires. Argentina]}
  \ecvitem{}{\textit{UBACyT Project: Action, structure and the problem of social order} -- with Professor Carlos Belvedere}
...
%     \item 
    ...
    \item Proficient user of several coding languages, used in a daily basis 
