...
%   \ecvtitlelevel{2012--2014}{Master in Sociology. Dissertation Title: 'Urban Art. Expressive uses of public space’, 
%   Empirical research on graffiti/pixação}{\href{http://ramoneando.com/docs/Juarez,Benjamin_M.pdf}{\texttt{*online pdf link}}
%   }
...
%   }
  ...
  \ecvsection{\fbox{Teaching Positions}}
  
  \ecvitem{ACADEMIC}{%
  \noindent\fbox{%
    \parbox{0.7\textwidth}{%
  Over the past 5 years I have assisted students with graduate level projects. I read their texts and made observations on methodological and empirical topics, pointing out contents and readings, following up on each student.}}
  }
...
%   \pagebreak
  \ecvsection{Teaching Positions}
  \ecvitem{EXTRA ACADEMIC}%
  {\noindent\fbox{\parbox{0.7\textwidth}{%
  The last two years I have been giving Sociology classes at an institution for the general \mbox{public}. The responses of the students and staff have been very positive and the experience of \mbox{teaching} has been personaly very grateful. I see it as a posibility to put research questions into play and to probe the general feeling that sociological research has for a wider public.
  }} }
  \ecvitem{}%
  {\noindent\fbox{\parbox{0.7\textwidth}{Over the past 4 years I have given a number of Workshops on Running. I instruct on the Technique ChiRunning, and have traveled through the country assisting runners of various levels, from beginners to advanced. Which favors my research purpose, on ultrarunning. }} }
  \ecvitem{}{
  \noindent\fbox{%
    \parbox{0.7\textwidth}{%
  Additionaly, as a native american living in Argentina I have given conversation classes en English, for scholars and the general public, with a range of academic students ranging from philosophy, to tourism and biochemistry. }}
  }
...
\ecvblueitem{Book}{Independent Publication \textsc{Unexplicable Publishers}.} \vspace*{-5mm}
...
%     \item 
    ...
    \item  \url{http://ramoneando.com/} | I run my personal blog with %sociological observations, 
