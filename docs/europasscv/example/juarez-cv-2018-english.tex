...
\ecvsection{\mybox{Teaching Positions}}
  ...
  The last 2 years I have been giving Sociology classes at \textit{Centro de Espiritualidad Santa María}.
%   The responses of the students and staff have been very positive and the experience of \mbox{teaching} has been very gratifying personally. 
  I see it as a possibility to put research questions into play and to probe the general feeling that sociological research has for a wider public.
  }}
  }
...
\ecvitem{\mybox{EXTRA ACADEMIC}}%
  {\noindent\fbox{\parbox{0.7\textwidth}{%
%   Over the past 4 years I have given a number of Workshops on Running. I instruct on the ChiRunning Technique, and have traveled through the country assisting runners of various levels, from beginners to advanced. Which favors my research purpose, on ultrarunning. }} }
%   \ecvitem{}{
%   \noindent\fbox{%
%     \parbox{0.7\textwidth}{%
  English is my native tongue: I was born in USA and am an American living in Argentina since age 7. I have given conversation classes in English, for scholars and the general public, with a range of academic students coming with academic background ranging from philosophy, to tourism and biochemistry. 
  }}
  }
