...
\aboutme{Hice Sociología a nivel de Licenciatura y Maestría. Recientemente trabajé fuera de la universidad. Armé proyecto propio: un bar de jugos de fruta natural, \textit{Juice Bar}. También conocí el mundo empresarial trabajando en \textit{Pearson} entre 2017 y 2018.} % To have no About Me section, just remove all the text and leave \aboutme{}
%----------------------------------------------------------------------------------------
%	 SKILLS
%----------------------------------------------------------------------------------------
...
- crm: salesforce \newline
- en curso: Jquery Angular ApiRest Mongodb Node.js Express.js Bootstrap
}
% web: html css md javascript 
...
%para empujar de manera continua. 
Me crié en Córdoba desde los 7 años. Antes viví en EEUU. 
Desarrollé desde temprana edad gusto por el idioma: estudié inglés hasta nivel nativo C1 [CEFR] y lo uso a diario para leer y escribir. También %aprendí a 
leo, escucho y hablo portugués fluidamente, estuve en Brazil más de dos años. 
Programación: varios años autodidacta, ahora en Curso de Desarrollo Web en UTN.\\

\section{Trabajo reciente}

\begin{twentyshort} % Environment for a short list with no descriptions
	\twentyitem{2018–2019}{Asistente de Investigación}{Royal Roads, British Columbia, CA}{Logística y edición de entrevistas
% 	traducción, transcripciones, edición de materiales 
...
\begin{twenty} % Environment for a list with descriptions
 %
	\twentyitem{desde 2018}{Curso de Desarrollo Web}{[UTN, Córdoba, Argentina]}{
