...
\title{adscripción}                               % optional, remove / comment the line if not wanted
...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{Universidad de Villa María}{%
Facultad de Sociología\\
Adscripción en \textit{Metodología de la Investigación}
