% \documentclass[nols,notoc,a4paper,justified,spanish]{tufte-book} % symmetric
...
\openepigraph{%
\vfill %
\emph{Dedicado a todos los que creen en el desarrollo sostenible de sus comunidades.} \vfill
\emph{A los que se atreven a emprender, a ser disruptivos en las soluciones y hacer frente a los desafíos que enfrenta el planeta.}
} 
\vfill
...
\par © 2019 - Green Drinks Córdoba 2ª EdiciónTodos los derechos reservados.\\
...
\par\textit{Segunda edición, Noviembre 2019}
\end{fullwidth}
...
% \input{capitulos/experiencias-libro}
% \input{capitulos/partes.tex}

\begin{fullwidth}

% \cleardoublepage
\addtocontents{toc}{\protect\enlargethispage{\vfill}}
 
\input{capitulos/prologo.tex}
\authortoc{Fernando Colautti}

\part{\textsc{Redes e intercambios}}
% \addcontentsline{toc}{part}{%
% \arabic{part}.\arabic{part}.\arabic{part}.\arabic{part}~~ 
% Redes e intercambios}
% \addcontentsline{Redes e intercambios}{}{Redes e intercambios}
\input{capitulos/conectando}          \authortoc{Elga Ruth Velásquez}	% Redes Cambio 
\input{capitulos/pacha}               \authortoc{Claudia Lamas}	% Redes
\input{capitulos/ecosistema-verdades} \authortoc{Marcos S. Karlin}	% Cambio/Conservación

\part{\textsc{Aire, conservación y conciencia verde}}
\input{capitulos/recuperando-verde}   \authortoc{Leonardo Peralta}	% AIRE
\input{capitulos/parques}             \authortoc{Emmanuel Baghin}	% AIRE
\input{capitulos/reserva-respira}     \authortoc{Rita Stanislavs}	% AIRE
\input{capitulos/sustentable-rebeldia}\authortoc{Fabián Gabriel Fábrega}% Cambio/Conservación Eco Comida?

\addtocontents{toc}{\protect\enlargethispage{\clearpage}}
% \addtocontents{toc}{\protect\enlargethispage{3\baselineskip}}

\part{\textsc{Reciclando. Nuevos valores y recursos}}
\input{capitulos/desperdicio-cero}    \authortoc{Natalia Emma Basso}	% BASURA
\input{capitulos/residuo-cero}        \authortoc{Daniel Blanco}	% BASURA
\input{capitulos/biobriz}             \authortoc{Daniel Horacio Blando}	% BASURA
\input{capitulos/basura-recurso}      \authortoc{Pablo Martín Capitanelli}	% BASURA

\part{\textsc{Cambios productivos, legales y de difusión}}
\input{capitulos/mikuna}              \authortoc{Ignacio y Agustín Mayorga}	% Cambio/Conservación Eco Comida
\input{capitulos/escuela}             \authortoc{Gladis Vera}		% Cambio
\input{capitulos/chacra}              \authortoc{Federico Uanino}	% Cambio/Conservación
\input{capitulos/ordenanza}           \authortoc{Matías Roldán}		% Cambio
\input{capitulos/rse}                 \authortoc{Lucy Vilte}		% Cambio

\input{capitulos/gracias}             % Redes
\end{fullwidth}
