...
\input{capitulos/conectando}          % Redes Cambio
\input{capitulos/pacha}               % Redes
\input{capitulos/ecosistema-verdades} % Cambio/Conservación

\part{\textsc{Aire, conservación y conciencia verde}}
\input{capitulos/recuperando-verde}   % AIRE
\input{capitulos/parques}             % AIRE
\input{capitulos/reserva-respira}     % AIRE
\input{capitulos/sustentable-rebeldia}% Cambio/Conservación Eco Comida?

\part{\textsc{Reciclando. Nuevos valores y recursos}}
\input{capitulos/desperdicio-cero}    % BASURA
\input{capitulos/residuo-cero}        % BASURA
\input{capitulos/biobriz}             % BASURA
\input{capitulos/basura-recurso}      % BASURA

\part{\textsc{Cambios productivos, legales y de difusión}}
\input{capitulos/mikuna}              % Cambio/Conservación Eco Comida
\input{capitulos/escuela}             % Cambio
\input{capitulos/chacra}              % Cambio/Conservación
\input{capitulos/ordenanza}           % Cambio
\input{capitulos/rse}                 % Cambio
