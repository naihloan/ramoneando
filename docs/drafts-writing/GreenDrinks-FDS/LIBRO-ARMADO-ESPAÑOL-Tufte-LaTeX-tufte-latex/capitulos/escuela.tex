     \end{fullwidth}
\chapter*{COMPROMISO ESCOLAR \\ CON EL MEDIO AMBIENTE}
\addcontentsline{toc}{chapter}{COMPROMISO ESCOLAR CON EL MEDIO AMBIENTE}
\label{compromiso-escolar-con-el-medio-ambiente}
  \begin{fullwidth}
