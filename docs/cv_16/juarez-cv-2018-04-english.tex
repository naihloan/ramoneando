...
\skills{%
{programming: javascript php/3.7},
{web: html css md/4.2},
...
\begin{twenty} % Environment for a list with descriptions
 	...
 	\twentyitem{since 2013}{Programming-editing languages}{Hands-on}{I self-published my book [\textit{exhalations}] and web site [\texttt{ramoneando.com}]}
