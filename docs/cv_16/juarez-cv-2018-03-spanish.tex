...
\cvmail{benja.juarez@hotmail.com} % Email address
...
\aboutme{%
Hice Sociología a nivel de Graduación y también a nivel de Maestría. En el último tiempo busqué generar recursos fuera del ambiente universitario. Hice experiencia montando un proyecto propio: un bar de jugos de fruta natural, \textit{Juice Bar}. También conocí el mundo empresarial trabajando en \textit{Pearson} entre 2017 y 2018.
...
\skills{{diseño web: markdown + html-css/4.2},
{edición-tecnología: \LaTeX-vim/4.4},
{idioma inglés (nativo)/5.5},
{esfuerzo/5.9},
...
\skillstext{{capacidad de aprendizaje/9},{relajado/6,5}}
...
\begin{twentyshort} % Environment for a short list with no descriptions
	...
	\twentyitemshort{2012--}{Clases de Sociología [Argentina-Brasil]}
	\twentyitemshort{2015--}{Cursos de conversación en inglés [Córdoba, Argentina]}
...
\begin{twenty} % Environment for a list with descriptions
	...
	\twentyitemshort{2005-hoy}{simpatizante del uso de teclado dvorak}
	%\twentyitem{<dates>}{<title>}{<location>}{<description>}
\end{twenty}
