...
Experienced
  \begin{itemize}
    ...
    \item Startup XP. Stages: A, Pre-Seed
...
% Analytical and
Metrics-driven,
with a test-and-learn approach to meeting goals.
% Not afraid
OK
to make decisions with incomplete information and be accountable for the results.
