...
% twitter X symbol
% https://tex.stackexchange.com/questions/691908/new-twitter-symbol
\usepackage{amssymb}
\DeclareUnicodeCharacter{1D54F}{$\mathbbmss{X}$}

% Use these two lines for lowercase X:
\usepackage{bbm}
\DeclareUnicodeCharacter{1D569}{$\mathbbmss{x}$}
...
% \pagestyle{fancyhdrs}
% \lfoot{Last updated: \today % \datetime
% }
% \cfoot{}
% \lfoot{Page \thepage}
% % % % % % % % % % % % % % % % 
