...
git github gitlab mysql ssh \\ % mongodb express.js angular node.js 
...
]}{Segundo Año en curso. Primer Año Completo.}
...
% \include{english-info.tex}

\begin{twentyshort} % Environment for a short list with no descriptions
	\twentyitem{2019--2020}{Desarrollador Web}{[Ross | Outside the Box. Córdoba, Argentina]}
