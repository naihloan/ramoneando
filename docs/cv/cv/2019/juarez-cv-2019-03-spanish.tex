...
\cvnumberphone{(+54 9 351) 153 104043} \cvsite{http://ramoneando.com/} \cvmail{benjaminjuarezarlt@gmail.com}
...
\tech{%
- web: html css javascript Node.js Express.js Bootstrap md  \newline
...
\begin{twentyshort} % Environment for a short list with no descriptions
	\twentyitem{2019–}{Traductor Freelance [español $>$ inglés]}{Fundación Desarrollo Sostenible}{%
	\textsc{LIBRO:} \textit{Experiencias Sustentables que transforman comunidades. ¡Inspírate e impulsa tu idea!}
	}
...
% 	HTML5 CSS3 Bootstrap}
	\twentyitemshort{2018–2019}{Asistente de Investigación | Productor [Canadá \& Argentina]}
% 	Royal Roads, British Columbia, CA
