...
\begin{tabular}{@{} l}
    Recruitment Office \\ % 	Recruiter %Person 	\\ % 	Recruitment Officer \\
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
    Clipboard Health
    \\ 
    USA / Remote
...
Dear Wyatt, %Amaral,
% Carlos Correia Santos and Team,
\bigskip % Vertical whitespace
...
% 4
Later, in a 3rd period, I worked as a Project Manager close to the Development and QA teams:
