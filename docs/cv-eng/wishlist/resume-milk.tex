...
\cvjobtitle{trilingual sociologist %web developer 
$ $  $ $  $ $ $ $ $ $ $ $ [US Citizen]} % Job title/career
...
% \cvskype{\href{Skype}{Skype details}}
...
Born and raised in USA until age 7. Then Argentina.
...
\tech{
- markup: html css md \LaTeX $ $ Bootstrap \newline %
- web: php javascript vcs (git)\newline
- programming: java lua node.js \newline 
- editing: vim ranger  \newline %
- ongoing: Jquery Angular ApiRest Mongodb Node.js Express.js 
}
% }
