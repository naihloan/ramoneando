...
\begin{twentyshort} 
	\twentyitem{2020--today}{Customer Developer}{[Cintelink Argentina - Fuel Business Intelligence]} % Córdoba, Argentina]}
        {backoffice: python, php, sql, nodejs. agile/Kanban jira}
