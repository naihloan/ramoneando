...
an aspiring programmer. % at heart.
...
I feel at ease in environments relating to publishing, film production, programming, and non-profit. % and service.
...
\begin{twentyshort} 
	\twentyitem{2020--today}{Customer Dev [Backoffice]}{[Cintelink Argentina. Fuel Business Intelligence]} % Córdoba, Argentina]}
        {python, php, sql, nodejs, vue, docker. IoT. agile/Kanban}
...
%         We deliver results in small increments: my first solo project used the Knime platform to manage big data sets with SQL-type queries.} % docker
	\twentyitemshort{2019--2020}{Back End Web Developer [Ross | Outside the Box. Córdoba, Arg.]}
%         {% %         Back End | Full Stack [nodejs express mariaDB | (react angular)] \\ %         This is my first experience 
%         We work in an agile environment. 
%         I use source code versioning and Kanban methodology [jira] on a daily basis.
%         We deliver results in small increments: my first solo project used the Knime platform to manage big data sets with SQL-type queries.} % docker
