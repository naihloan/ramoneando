...
\newcommand*{\runninghead}{Cómo la gente corriente se convierte en monstruos... o héroes} % Running head displayed on almost all slides
\newcommand*{\myauthor}{CESM/CAE: Sociología} % Presenters name(s)
\newcommand*{\mydate}{\today} % Presentation date
\newcommand*{\myuni}{según video (2008) de Philiip Zimbardo
%CESM
%CENTRO DE ESPIRITUALIDAD SANTA MARÍA
% --- \textit{CURSO DE ACOMPAÑAMIENTO ESPIRITUAL (CAE)}
...
% \section{Philiip Zimbardo:}

%\section{Philip Zombardo}\label{philip-zombardo}

\begin{itemize}
\subsubsection{7 Procesos sociales que facilitan comportamientos
malvados %(por P. Zimbardo)
}\label{procesos-sociales-que-facilitan-comportamientos-malvados}

%\begin{minipage}[t][0pt]{\linewidth}
\begin{itemize}
\tightlist
\item
  Tomar el primer paso sin pensar
\item
  Deshumanizar al otro
\item
  Desindividualizarse {[}tornarse anónimo{]}
\item
  Difusión de la responsabilidad personal
\item
  Obediencia ciega a la autoridad
\item
  Conformación acrítica a las normas grupales
\item
  Tolerancia pasiva al mal a través de la inacción o indiferencia
\item
  En situaciones nuevas o poco conocidas
\end{itemize}
% \end{minipage}
