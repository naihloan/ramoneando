...
<style>
  /* Fix low-contrast grey text in dark mode */
  body {
    color: #e9ecef !important; /* Light grey main text */
  }
  p, .caption, .gallery-item p, .portfolio-section p {
    color: #ced4da !important; /* Softer light grey for descriptions/captions */
  }
  a {
    color: #74b9ff !important; /* Brighter blue links */
  }
  a:hover {
    color: #a6dcef !important;
  }
  h1, h2, h3, h4, h5, h6 {
    color: #ffffff !important; /* Pure white headers */
  }
  /* Specific fixes if you have these classes */
