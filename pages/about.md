...
<section id="testimonials" style="margin-top: 40px; color: #f0f0f0;">
  <h2 style="border-bottom: 2px solid #444; padding-bottom: 10px;">Nice things people say about me</h2>
  
  <div class="testimonial-grid">
    
    <div class="testimonial-card">
      <div class="testimonial-header">
        <img src="https://media.licdn.com/dms/image/v2/D4D03AQFkunQrHU2PBw/profile-displayphoto-scale_400_400/B4DZmbRkTHJMAg-/0/1759246698377?e=1772064000&v=beta&t=Q_KkR2imjcKuI7HFCCTjJ9TtiC_tSzx_Yv6ao027G9s" alt="Colleague 1" class="testimonial-avatar">
...
<style>
  ...
  .testimonial-avatar {
    ...
    height: 45px;
    border-radius: 50%;
    filter: grayscale(100%); /* Keeps the indie/mono look */
